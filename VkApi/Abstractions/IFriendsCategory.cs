...
namespace VkNet.Abstractions
{
	...
	public interface IFriendsCategory : IFriendsCategoryAsync
	{
		...
		/// </remarks>
		ReadOnlyCollection<long> GetMutual(FriendsGetMutualParams @params);
		...
		/// </remarks>
		ReadOnlyCollection<AreFriendsResult> AreFriends( 
		...
		/// </remarks>
		VkCollection<User> GetSuggestions(FriendsFilter filter = null
										, long? count = null
										, long? offset = null
